    ...
    static func startIfRequested(_ model: AppModel) {
        ...
        Task { @MainActor in
            ...
            do {
                ...
                guard configuration["mcpServers"]?["rebot-motion-lab-grok"]?["command"] as? String == control.executable else { throw CheckError.failed("MCP copied JSON changed the executable path") }
