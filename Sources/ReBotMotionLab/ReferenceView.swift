        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 24) {
                ...
                referenceCard(title: "Scope", value: "Kinematic", caption: nil,
                    description: "The solid base plane stops every moving link and both gripper fingertips. This app does not model self-collisions, other obstacles, payloads, forces, torque, drive response, or thermal behavior. It does not connect to hardware. Actuator settings are a separate reference and do not change simulation behavior. Gripper opening is nominal 0–90 mm; the tool center is the source end_link origin at the closed fingertip center.") { EmptyView() }
